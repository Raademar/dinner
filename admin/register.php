    ...
    <div class="col-sm-12">
      <div class="row">
        <div class="col-sm-6 form-group">
          ...
          <input type="text" placeholder="Enter Username Here.." class="form-control" id="usernameRegister" name="usernameRegister" required>
        </div>
        <div class="col-sm-6 form-group">
          <label for="passwordRegister">Password</label>
          <input type="password" placeholder="Enter Password Here.." class="form-control" id="passwordRegister" name="passwordRegister" required>
        </div>
      </div>
      <div class="row">
        <div class="col-sm-6 form-group">
          <label>First Name</label>
          <input type="text" placeholder="Enter First Name Here.." class="form-control" id="firstnameRegister" name="firstnameRegister" required>
        </div>
          <div class="col-sm-6 form-group">
            <label>Last Name</label>
            <input type="text" placeholder="Enter Last Name Here.." class="form-control" id="lastnameRegister" name="lastnameRegister" required>
          </div>
        </div>
      <div class="form-group">
        <label>Email Address</label>
        <input type="text" placeholder="Enter Email Address Here.." class="form-control" id="emailRegister" name="emailRegister" required>
      </div>
      <div class="form-group">
